...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2015 at 06:39 PM
...
--
-- Table structure for table `customer_machine_hours_alerts`
--

CREATE TABLE IF NOT EXISTS `customer_machine_hours_alerts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) NOT NULL,
  `customer_name` varchar(255) NOT NULL,
  `machine_id` int(11) NOT NULL,
  `part` varchar(255) NOT NULL,
  `75_percent_acknowledged` int(1) NOT NULL,
  `90_percent_acknowledged` int(1) NOT NULL,
  `95_plus_percent_acknowledged` int(1) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `customer_machine_hours_log`
--

CREATE TABLE IF NOT EXISTS `customer_machine_hours_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) NOT NULL,
  `customer_name` varchar(255) NOT NULL,
  `dir_name` varchar(255) NOT NULL COMMENT 'the date that the hour logs are from',
  `customer_machine_type` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=33 ;
