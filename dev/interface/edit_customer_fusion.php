...
if(isset($_REQUEST["editCustMachineNow"])){
	$newCustomer->setCustomer($customer_id, "f");
	...
	//header('Location: add_customer_fusion.php');
}
...
<div class='pageTitle' >Edit Fusion for <?php echo $newCustomer->name; ?></div>
...
<div class="formBackground_adm">
	<form name="editCustomerFusionForm" action="edit_customer_fusion.php" method="POST" onsubmit="return checkRequiredFields()" >
		<table border='0' >
		<tr>
			<td class='formLabel' >
		...
		<tr>
			...
			<input type="submit" value="Edit Customer Fusion" /> 
			</td>
		</tr>
