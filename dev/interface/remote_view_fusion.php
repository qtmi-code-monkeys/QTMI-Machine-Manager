...
$tmpCustomerName = "";
if(isset($_REQUEST["username"])) $tmpCustomerName = $_REQUEST["username"];
...
<TITLE>Remote View for: <?php echo $newCustomer->name; ?></TITLE>
  ...
  <FRAMESET rows="80, 400">
      <FRAME src="remote_view_fusion_frameTop.php?customerName=<?php echo $tmpCustomerName; ?>&customerId=<?php echo $_SESSION['customerId']; ?>&retreiveMessage=<?php $_REQUEST["retreiveMessage"]; ?>">
