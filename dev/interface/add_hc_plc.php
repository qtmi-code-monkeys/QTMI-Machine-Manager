...
$listFiles->code_base = "PLC";

$linkMaker = new linkMaker();
$linkMaker->machine_type = "HC";
$linkMaker->code_base = "PLC";
...
<?php if($appManager->isAdmin()) {?>
	<div class="formBackground_adm">
		...
		<h1 class='formLabel' >Upload File: <font style='font-size:16; font-weight:16; color:red'> (Extension must be cxp)</font> </h1>
